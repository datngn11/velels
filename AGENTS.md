...
- Product data lives in `src/lib/data/products.ts` (11 products), with per-product
  ...
  files must stay key-identical** — 289 leaf keys across 12 top-level namespaces,
  383 counting intermediate objects, verified 2026-09-23. Adding a key to one and
