  ...
  return (
    <section className="w-full h-[90vh] min-h-[600px] relative overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-20 text-center px-margin-mobile md:px-margin-desktop flex flex-col items-center gap-stack-sm max-w-3xl">
        ...
        <p
          className="text-body-lg text-on-primary/90 max-w-xl mb-6 opacity-0 animate-fade-in-up"
        ...
        <button
          ...
          className="inline-block bg-primary text-on-primary text-label-md px-8 py-4 opacity-0 animate-fade-in-up hover:scale-105 transition-all duration-300 cursor-pointer"
