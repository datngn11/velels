...
export default async function ProductPage({ params }: Props) {
  ...
  return (
    <>
      <Navbar />
      <div className="mt-20 md:mt-18 w-full max-w-container mx-auto px-margin-mobile md:px-margin-desktop">
        <Breadcrumbs items={crumbs} label={tDetail("breadcrumbLabel")} />
      </div>
      <main className="flex-grow w-full max-w-container mx-auto px-margin-mobile md:px-margin-desktop pt-stack-sm md:pt-stack-md pb-stack-md md:pb-stack-lg flex flex-col md:flex-row gap-gutter md:gap-margin-desktop">
